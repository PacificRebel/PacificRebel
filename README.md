...
|    **Weather App**
|               `Next.js` app which calls the Openweathermap API, styled with `Chakra`. Under construction! 🛠  <br/> </br> Tech stack: `React (Next.js)`, `Chakra`, `CSS`, `HTML` |  <img src="/public/Next_js_openweather.gif"/>
|     **Jack The Ripper**
