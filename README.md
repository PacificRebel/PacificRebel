<img class=one src="./public/My_name.png" width="210" height="45"/> <a  href="https://www.linkedin.com/in/heli-sivunen/"> <img align="right" src="/public/LI-In-Bug.png" width="25" height="25"/><a  href="https://twitter.com/Heli_Sivunen"> <img align="right" src="/public/Twitter_Social_Icon_Square_Color.png" width="25" height="25"/></a>
...
|               `Next.js` app which calls the OpenWeatherMap API, styled with `Chakra`.<br>Deployed: https://practical-liskov-2292fb.netlify.app/<br /> Under construction! 🛠  <br/> </br> Tech stack: `React (Next.js)`, `Chakra`, `CSS`, `HTML` |  <img src="/public/Nexj_js_openweather.gif"/>
...
|              My portfolio, linked to my repos via the GitHub API. <br /><br /> Tech stack: `Gatsby`,`React`, `Flexbox`, `Google Fonts`. <br /><br>Deployed: https://friendly-kepler-67683c.netlify.app/<br /> Under construction! 🛠                                         | <img src="/public/Portfolio.gif"/> |
